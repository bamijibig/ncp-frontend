...
export class AllpubconnectionComponent implements OnInit {
  displayedColumns = [ 'community_name', 'chairman_comm_number', 'chairman_comm_name', 'date_of_application']
  displayedColumnslist = [ 'region','hub','name_sponsor','community_name','chairman_comm_name', 'chairman_comm_number','status' ]
